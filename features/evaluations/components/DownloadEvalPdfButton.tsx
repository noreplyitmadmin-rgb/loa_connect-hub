...
export function DownloadEvalPdfButton({
  ...
  return (
    <button
      ...
      className={`inline-flex items-center gap-2 text-xs font-semibold px-4 py-2 rounded-lg bg-blue-600 text-white hover:bg-blue-700 shadow-sm transition-colors ${className}`}
    >
