    ...
    <div className="max-w-3xl mx-auto space-y-8 pb-12">
      ...
      <div className="card p-6 bg-white space-y-4">
        ...
        <div className="bg-slate-50 rounded-lg p-4 text-xs font-mono text-slate-600 leading-relaxed">
          ...
          Alice Student, alice.student@itmlyceumalabang.onmicrosoft.com, BS Computer Science<br />
          Bob Martinez, bob.martinez@itmlyceumalabang.onmicrosoft.com, BS Information Technology
        </div>
        <ul className="text-xs text-slate-500 space-y-1 list-disc list-inside">
          ...
          <li><strong>Course</strong> is optional but recommended</li>
        </ul>
      </div>
