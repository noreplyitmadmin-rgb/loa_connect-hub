...
export default function AdminEvaluationResultsPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-6 pb-12">
      <div>
        <h1 className="text-xl font-bold text-primary">Evaluation Results</h1>
        <p className="text-sm text-tertiary mt-1">View faculty evaluation results</p>
      </div>
      ...
      {loading ? (
        ...
        <p className="text-sm text-tertiary text-center py-12">No results available. Compute results first.</p>
      ) : (
