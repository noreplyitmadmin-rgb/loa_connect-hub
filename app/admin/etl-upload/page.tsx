...
type ImportType = "students" | "users"
  ...
  return (
    <div className="max-w-6xl mx-auto space-y-8 pb-12">
      <div>
        ...
        <p className="text-sm text-tertiary mt-1">Upload a CSV file to create users.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        >
          ...
          <div className="bg-surface rounded-lg p-3 text-[10px] font-mono text-secondary leading-relaxed">
            name, microsoft email, employee no, department, dean
          </div>
          <a
